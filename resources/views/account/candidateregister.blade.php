...
<div class="row">
<div class="col-xs-12">
<a href="/" title="CharityJob the charity sector specialists" id="secondary-logo" class="ga-homepage-charityjob">
...
<div class="top">
<h1 class="h1">
Let's create your candidate account.
</h1>
</div>
<div class="bottom">
<p>Register with us in 2 minutes, and get started finding your dream job!</p>
</div>
</div>
</div>
    </div>
...
@section('scripts')
    {!! JsValidator::formRequest('Boaz\Http\Requests\Auth\RegisterRequest', '#registration-form') !!}
@stop