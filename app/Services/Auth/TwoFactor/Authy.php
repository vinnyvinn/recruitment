...
namespace Boaz\Services\Auth\TwoFactor;

use Exception;
use GuzzleHttp\Client as HttpClient;
use Boaz\Services\Auth\TwoFactor\Contracts\Provider;
use Boaz\Services\Auth\TwoFactor\Contracts\Authenticatable as TwoFactorAuthenticatable;
