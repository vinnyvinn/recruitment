...
namespace Boaz\Http\Controllers\Web\Auth;

use Boaz\Events\User\LoggedIn;
use Boaz\Events\User\LoggedOut;
use Boaz\Events\User\Registered;
use Boaz\Http\Requests\Auth\LoginRequest;
use Boaz\Http\Requests\Auth\RegisterRequest;
use Boaz\Repositories\Role\RoleRepository;
use Boaz\Repositories\User\UserRepository;
use Boaz\Services\Auth\TwoFactor\Contracts\Authenticatable;
...
class AuthController extends Controller
{
    ...
    {
        $socialProviders = config('auth.social.providers');
        return view('account.candidateregister', compact('socialProviders'));
    }
    /**
    ...
    public function postRegister(RegisterRequest $request, RoleRepository $roles)
    {
        ...
        $role = $roles->findByName('Applicant');
