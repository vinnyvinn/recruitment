...
use Boaz\Http\Requests\Permission\CreatePermissionRequest;
use Boaz\Http\Requests\Permission\UpdatePermissionRequest;
use Boaz\Permission;
...
class PermissionsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('permission.index', compact('roles', 'permissions', 'edit'));
    }
