...
namespace Boaz\Repositories\Role;

use Boaz\Events\Role\Created;
use Boaz\Events\Role\Deleted;
use Boaz\Events\Role\Updated;
use Boaz\Role;
use Boaz\Support\Authorization\CacheFlusherTrait;
use DB;
